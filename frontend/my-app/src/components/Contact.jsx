...
const Contact = () => {
  ...
  useEffect(() => {
    ...
    // Create particle animation (if needed)
    const createParticleCanvas = () => {
      ...
      class Particle {
        ...
        reset() {
          ...
          this.color = `rgba(200, 100, 255, ${Math.random() * 0.5 + 0.1})`;
  ...
  return (
    <div className="contact-container pt-20 relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-r from-blue-500 to-teal-500 text-white">
      {/* Optional Background Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-500 via-teal-500 to-black opacity-80" />

      {/* Contact Card Container */}
      <div className="relative z-10 w-full max-w-lg mx-auto px-4">
        <div className="contact-animation relative rounded-2xl p-6 backdrop-blur-md bg-black/40 border border-blue-600 shadow-2xl">
          {/* Neon Gradient Overlay */}
          <div className="absolute -inset-0.5 -z-10 rounded-2xl bg-gradient-to-r from-blue-500 via-teal-500 to-black blur opacity-60" />
            ...
            <div className="contact-animation grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-black/30 border border-blue-600 p-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-400 transition-all duration-300 text-white placeholder-gray-400 text-sm"
